...
gebicPhysListHadron::gebicPhysListHadron(const G4String& name)
...
gebicPhysListHadron::~gebicPhysListHadron()
{}
...
void gebicPhysListHadron::ConstructProcess()
{
  ...
  //  fTheAlphaInelasticProcess->RegisterMe(fTheAlphaInelasticModel);
